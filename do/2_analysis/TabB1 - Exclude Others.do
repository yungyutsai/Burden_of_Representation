...
foreach y in sat rc sr{
	...
	outreg2 using "$tab/TabA3.xls", append dec(3) keep(prop_sub_samerace)
	...
	mi estimate,post: reg `y' c.prop_sub_samerace#i.race prop_sup_samerace $cov1 $cov2 $cov3 i.agencyrace i.year [aw=weight1], cl(agencyyear)
